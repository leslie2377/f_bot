...
class LocalKoreanEmbeddings extends Embeddings {
  constructor() {
    ...
    this.domainKeywords = [
      // 요금제 핵심
      '요금제', '요금', '가격', '월요금', '추천', '비교', '가성비', '저렴', '싼', '저가', '고가',
      '데이터', '통화', '문자', '무제한', '기본제공', '대용량', '소용량',
      'skt', 'kt', 'lgu', 'lg', '알뜰폰', '통신망',
      '프로모션', '할인', '프로모', '정가', '무약정', '평생',
      // 제휴/브랜드
      '제휴', '하나은행', '신한카드', 'cu', 'nh', '밀리의서재', 'cgv', '다이소', '올리브영', '예스24',
      // 데이터 용량
      '5g', 'lte', '3g', '5gb', '7gb', '10gb', '11gb', '15gb', '20gb', '30gb', '50gb', '100gb', '200gb',
      // 개통
      '개통', '셀프개통', '유심', 'esim', '이심', '번호이동', '신규가입', '신규',
      '준비물', '신분증', '인증', '안면인증', '본인인증',
      // 약관/계약
      '해지', '약관', '계약', '환불', '납부', '결제', '자동이체',
      // 고객
      '고객센터', '상담', '문의', '전화번호',
