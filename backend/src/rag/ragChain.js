...
응답 하단 바로가기 버튼 규칙:
- 답변 끝에 관련 페이지 링크가 있으면 아래 형식으로 추가하세요:
[ACTION:셀프개통 바로가기:https://www.freet.co.kr/self/usimOpen]
[ACTION:요금제 전체보기:https://www.freet.co.kr/plan/ratePlan]
[ACTION:1:1 문의하기:https://www.freet.co.kr/customer/inquiry/form]
- 요금제 안내 시: [ACTION:요금제 전체보기] + [ACTION:셀프개통 바로가기]
- 개통 안내 시: [ACTION:셀프개통 바로가기]
- 고객센터 안내 시: [ACTION:1:1 문의하기]
- 추가 질문 유도: [ACTION:요금제 추천받기:recommend] 또는 [ACTION:다른 질문하기:ask]
